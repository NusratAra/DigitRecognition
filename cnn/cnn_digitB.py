...
trainf = open("train_images.txt", "r")
train =  trainf.read().split(',')

trainlf = open("train_lebels.txt", "r")
trainl =  trainlf.read().split(',')

testf = open("test_images.txt", "r")
test =  testf.read().split(',')

testlf = open("test_lebels.txt", "r")
testl =  testlf.read().split(',')
